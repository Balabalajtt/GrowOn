...
public class GaofenFragment extends Fragment{
    RecyclerView mRecyclerView;
    SwipeRefreshLayout mSwipeRefreshLayout;
    DoubanAdapter adapter;
    int start = 0;
    static String tag = "豆瓣高分";
...
//                NetWork.requestDouban(baseUrl + start, tag);
        ...
        adapter = new DoubanAdapter(getContext(), DoubanData.subjects4);
//        final StaggeredGridLayoutManager manager = new StaggeredGridLayoutManager(4, StaggeredGridLayoutManager.VERTICAL);
        ...
        adapter.setOnItemClickListener(new DoubanAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                intent.putExtra("url", DoubanData.subjects4.get(position).url);
                intent.putExtra("id", DoubanData.subjects4.get(position).id);
