...
public class LengmenFragment extends Fragment{
    RecyclerView mRecyclerView;
    SwipeRefreshLayout mSwipeRefreshLayout;
    DoubanAdapter adapter;
    int start = 0;
    static String tag = "冷门";
...
//                requestDouban();
        ...
        adapter = new DoubanAdapter(getContext(), DoubanData.subjects5);
//        final StaggeredGridLayoutManager manager = new StaggeredGridLayoutManager(4, StaggeredGridLayoutManager.VERTICAL);
        ...
        adapter.setOnItemClickListener(new DoubanAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                intent.putExtra("url", DoubanData.subjects5.get(position).url);
                intent.putExtra("id", DoubanData.subjects5.get(position).id);
