...
public class JinDianFragment extends Fragment{
    RecyclerView mRecyclerView;
    SwipeRefreshLayout mSwipeRefreshLayout;
    DoubanAdapter adapter;
    int start = 0;
    static String tag = "经典";
...
//                requestDouban();
        ...
        adapter = new DoubanAdapter(getContext(), DoubanData.subjects3);
//        final StaggeredGridLayoutManager manager = new StaggeredGridLayoutManager(4, StaggeredGridLayoutManager.VERTICAL);
        ...
        adapter.setOnItemClickListener(new DoubanAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                intent.putExtra("url", DoubanData.subjects3.get(position).url);
                intent.putExtra("id", DoubanData.subjects3.get(position).id);
