...
//                requestDouban();
        ...
        adapter = new DoubanAdapter(getContext(), DoubanData.subjects2);
//        final StaggeredGridLayoutManager manager = new StaggeredGridLayoutManager(4, StaggeredGridLayoutManager.VERTICAL);
        ...
        adapter.setOnItemClickListener(new DoubanAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                intent.putExtra("url", DoubanData.subjects2.get(position).url);
                intent.putExtra("id", DoubanData.subjects2.get(position).id);
